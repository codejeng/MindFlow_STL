...
export const EXPERT_CATEGORIES = [
  { id: "stress",       label: "ความเครียด / วิตกกังวล" },
  { id: "social",       label: "ภาวะสังคม" },
  { id: "health",       label: "บุคลากรสุขภาพ" },
  { id: "relationship", label: "ความสัมพันธ์" },
  { id: "children",     label: "เด็กและวัยรุ่น" },
  { id: "work",         label: "การเงิน / การทำงาน" },
  { id: "growth",       label: "การพัฒนาตนเอง" },
  { id: "family",       label: "ครอบครัว / สุขภาพจิต" },
];

export const EXPERTS: Expert[] = [
  {
    id: "1",
    name: "อ.ณิชกุล ขันบุตรศรี",
    nameEn: "Nichakun Khanbutsri",
    title: "ผู้เชี่ยวชาญให้การปรึกษา",
    specialty: ["ความเครียด", "สารเสพติด", "เด็กและวัยรุ่น"],
    categories: ["stress", "children"],
    rating: 5.0,
    reviewCount: 128,
    price: 1000,
    image: "/consultant/Consultant-1.jpg",
    experience: 10,
    languages: ["ไทย"],
    formats: ["online", "onsite"],
    about: "เชี่ยวชาญให้การปรึกษาเด็กและวัยรุ่นที่มีความเครียด และใช้สารเสพติด",
    available: true,
    badge: "แนะนำ",
  },
  {
    id: "2",
    name: "ผศ.ชมพูนุท ชนะมารดา",
    nameEn: "Asst. Prof. Chompoonut Chanamarn",
    title: "ผู้เชี่ยวชาญให้การปรึกษา",
    specialty: ["ซึมเศร้า", "ทำร้ายตนเอง", "เด็กและวัยรุ่น"],
    categories: ["stress", "children", "health"],
    rating: 5.0,
    reviewCount: 145,
    price: 1200,
    image: "/consultant/Consultant-2.jpg",
    experience: 15,
    languages: ["ไทย"],
    formats: ["online", "onsite"],
    location: "ขอนแก่น",
    about: "เชี่ยวชาญให้การปรึกษาเด็กและวัยรุ่นที่มีซึมเศร้า และพฤติกรรมทำร้ายตนเอง",
    available: true,
    badge: "แนะนำ",
  },
  {
    id: "3",
    name: "รศ.ดร.เนตรชนก แก้วจันทา",
    nameEn: "Assoc. Prof. Dr. Netchanok Kaewjantha",
    title: "ผู้เชี่ยวชาญให้การปรึกษา",
    specialty: ["วิตกกังวล", "ซึมเศร้า", "เด็กและวัยรุ่น"],
    categories: ["stress", "children", "health"],
    rating: 5.0,
    reviewCount: 204,
    price: 1500,
    ...
    languages: ["ไทย"],
    formats: ["online", "onsite"],
    about: "เชี่ยวชาญให้การปรึกษาเด็กและวัยรุ่นที่วิตกกังวล ซึมเศร้า",
    available: true,
    badge: "แนะนำ",
  },
  {
